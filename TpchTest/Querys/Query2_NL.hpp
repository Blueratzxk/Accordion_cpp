...
#ifndef OLVP_QUERY2_NL_HPP
#define OLVP_QUERY2_NL_HPP
...
class Query2_NL:public RegQuery
{
...
public:
    ...
    LookupJoinNode *createRegionJoinNationJoinSupplierJoinPartsupp()
    {
        ...
        ExchangeNode *tableScanPartsupp = createTableScanPartSuppToProbe();
    ...
    LookupJoinNode *create2TJ_PartJoinPartsupp()
    {
        ...
        ExchangeNode *tableScanPartsupp = this->createTableScanPartSuppToProbe();
    ...
    ExchangeNode *createTableScanPartSuppToProbe()
    {
