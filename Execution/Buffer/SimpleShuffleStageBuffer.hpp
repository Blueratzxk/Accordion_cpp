...
#ifndef OLVP_SIMPLESHUFFLESTAGEBUFFER_HPP
#define OLVP_SIMPLESHUFFLESTAGEBUFFER_HPP
...
class SimpleShuffleStageBuffer: public OutputBuffer
{
...
public:
    ...
    SimpleShuffleStageBuffer(OutputBufferSchema schema){
        this->setOutputBuffersSchema(schema);
    }

    string getInfo() {
        return "SimpleShuffleStageBuffer";
    }
...
#endif //OLVP_SIMPLESHUFFLESTAGEBUFFER_HPP
