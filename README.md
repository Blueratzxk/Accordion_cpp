...
* Execution Configuration. The `accordion/execution.config` file is used to configure the initial intra-task or instra-stage parallelism of the query execution.
