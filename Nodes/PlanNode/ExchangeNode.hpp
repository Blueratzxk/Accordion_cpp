...
public:
    ...
    {
        shared_ptr<Partitioning> par = Partitioning::create(SystemPartitioningHandle::SINGLE_DISTRIBUTION,{});
    ...
    {
        shared_ptr<Partitioning> par = Partitioning::create(SystemPartitioningHandle::FIXED_BROADCAST_DISTRIBUTION,{});
        vector<int> bucketToPartition;
        auto  scheme = make_shared<PartitioningScheme>(par,bucketToPartition);
    ...
    {
        shared_ptr<Partitioning> par  = Partitioning::create(SystemPartitioningHandle::FIXED_ARBITRARY_DISTRIBUTION,{});
        vector<int> bucketToPartition;
        auto  scheme = make_shared<PartitioningScheme>(par,bucketToPartition);
